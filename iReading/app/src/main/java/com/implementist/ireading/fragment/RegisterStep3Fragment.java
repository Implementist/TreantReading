...
public class RegisterStep3Fragment extends BaseFragment implements TextWatcher {
    ...
    private String strPhoneNumber, strSecurityStamp, strCiphertext;
    ...
    public void widgetOnClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnRegister:
                if (editRegisterRepeat.getText().length() > 0 && editRegisterPassword.getText().toString().equals(editRegisterRepeat.getText().toString())) {
                    //TODO: 获取随机数，生成密文，提交，注册完成，之后跳转回“我”页面
